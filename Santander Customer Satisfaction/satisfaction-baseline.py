...
filename = 'train.csv'
santa_frame = pd.read_csv(filename)
class_labels = santa_frame['TARGET'].values
del santa_frame['TARGET']
del santa_frame['ID']
X_train,X_test,y_train,y_test = train_test_split(santa_frame.values,class_labels,test_size=0.2,random_state=42)
