...
species_label = list(train_frame['species'].values)
del train_frame['id']
del train_frame['species']
encoded_frame = label_encode_frame(train_frame)
X_train,X_test,y_train,y_test = train_test_split(encoded_frame.values,species_label,test_size=0.2,random_state=42)
