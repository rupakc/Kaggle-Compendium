...
filename = 'train.csv'
poker_frame = pd.read_csv(filename)
hand_labels = list(poker_frame['hand'].values)
del poker_frame['hand']
X_train,X_test,y_train,y_test = train_test_split(poker_frame.values,hand_labels,test_size=0.2,random_state=42)
