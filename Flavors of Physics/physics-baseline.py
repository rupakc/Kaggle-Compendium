...
physics_frame = pd.read_csv(filename)
class_labels = list(physics_frame['signal'].values)
del physics_frame['signal']
del physics_frame['id']
X_train,X_test,y_train,y_test = train_test_split(physics_frame.values,class_labels,test_size=0.2,random_state=42)
