...
sentiment_labels = list(train_frame['Sentiment'].values)
phrase_list = list(train_frame['Phrase'].values)
del train_frame
feature_set = get_hashed_features(phrase_list)
X_train,X_test,y_train,y_test = train_test_split(feature_set,sentiment_labels,test_size=0.2,random_state=42)
