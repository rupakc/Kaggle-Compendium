...
mania_frame = pd.read_csv(filename)
target_variable = mania_frame['lscore'].values
del mania_frame['lscore']
del mania_frame['numot']
encoded_frame = label_encode_frame(mania_frame)
X_train,X_test,y_train,y_test = train_test_split(encoded_frame.values,target_variable,test_size=0.2,random_state=42)
