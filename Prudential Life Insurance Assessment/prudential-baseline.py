...
filename = 'train.csv'
insure_frame = pd.read_csv(filename)
class_labels = list(insure_frame['Response'].values)
del insure_frame['Response']
del insure_frame['Id']
impute = Imputer()
encoded_frame = label_encode_frame(insure_frame)
imputed_values = impute.fit_transform(encoded_frame.values)
classifier_list,classifier_name_list = get_ensemble_models()
X_train,X_test,y_train,y_test = train_test_split(imputed_values,class_labels,test_size=0.2,random_state=42)
