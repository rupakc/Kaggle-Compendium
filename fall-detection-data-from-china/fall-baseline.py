...
filename = 'falldetection.csv'
fall_frame = pd.read_csv(filename)
class_labels = list(fall_frame['ACTIVITY'].values)
del fall_frame['ACTIVITY']
X_train,X_test,y_train,y_test = train_test_split(fall_frame.values,class_labels,test_size=0.2,random_state=42)
