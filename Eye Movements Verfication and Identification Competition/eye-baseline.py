...
filename = 'train.csv'
eye_frame = pd.read_csv(filename)
class_labels = list(eye_frame['class'].values)
del eye_frame['class']
X_train,X_test,y_train,y_test = train_test_split(eye_frame.values,class_labels,test_size=0.2,random_state=42)
